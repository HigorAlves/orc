# Design Tokens & CSS-First Configuration (Tailwind v4)

Tailwind v4's CSS-first configuration: `@theme` blocks, semantic tokens with OKLCH, dark mode variants, the token hierarchy, and shared utilities.
