...
description: "Turn a decision you can't answer alone into a questionnaire for someone else to fill in — grill the send, not the subject. Joins the to-* family alongside orc:to-issues and orc:to-prd."
