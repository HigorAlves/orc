...
<p align="center">
  <code>76 skills</code> &nbsp;·&nbsp; <code>30 commands</code> &nbsp;·&nbsp;
...
> [!TIP]
> Pin a specific version: `orc install --ref orc--v0.17.0` (any existing release tag, or a commit SHA). Using `--ref` writes `settings.json` directly.
...
├── skills/<name>/SKILL.md       # 76 skills — a thin index per skill
