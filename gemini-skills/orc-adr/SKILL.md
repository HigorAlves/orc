...
ADRs in **Status: Proposed** that never get approved are rot. If you draft as Proposed, set a follow-up reminder via `AskUserQuestion`: "Revisit this in 1 week / 1 month / never (auto-archive)".
