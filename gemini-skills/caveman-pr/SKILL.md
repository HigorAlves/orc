---
name: caveman-pr
description: Ultra-compressed pull request descriptions. Same family as caveman-commit and caveman-review — terse, signal-only PR body. Use when opening a PR (via /orc:ship or gh pr create), when user says "write a PR description", "PR body", "draft the PR", or invokes /caveman-pr. Skips boilerplate the reviewer can read from the diff.
---
