...
description: Subagent that analyzes a too-big branch's diff and proposes how to split it into a stack of smaller PRs (slices + non-interactive rebase plan as JSON). Used by /orc:stack-pr --smart. Read-only — never runs rebase, cherry-pick, or any destructive operation.
---
